...
public class scoresAdapter extends CursorAdapter
{
    ...
    private int mDetailPosition = ListView.INVALID_POSITION;
    ...
    public void bindView(View view, final Context context, Cursor cursor)
    {
        ...
        mHolder.home_crest.setContentDescription(context.getString(R.string.a11y_home_icon, home));

        String away = cursor.getString(COL_AWAY);
        mHolder.away_name.setText(away);
        mHolder.away_crest.setContentDescription(context.getString(R.string.a11y_away_icon, away));
        ...
        if(mHolder.match_id == detail_match_id)
        {
            ...
            // remember selected detail position
            mDetailPosition = cursor.getPosition();
        }
        else
        {
