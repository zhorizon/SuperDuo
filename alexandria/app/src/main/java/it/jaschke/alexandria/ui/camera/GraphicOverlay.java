...
public class GraphicOverlay<T extends GraphicOverlay.Graphic> extends View {
    ...
    public static abstract class Graphic {
        ...
        public boolean isTapped(float rawX, float rawY) {
            return false;
        }
    }
    ...
    public T getTappedGraphic(float rawX, float rawY) {
        // translate raw coordinate to view system.
        Rect r = new Rect();
